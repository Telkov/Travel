...
<!--                        <form action="hotelinfo.php" class="form-inline">-->
                        <input type="submit" name="book" value="To Book" href="#" class="btn btn-primary btn-gradient">
<!--                        </form>-->
                    </div>
                </div>
                <div class="comments" align="left">
                    ...
                    $hid=$_GET['hid'];
                    connect();
                    $sel3='select*from Comments where hotelid='.$hid;
